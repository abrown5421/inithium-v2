/**
 * Tailwind's default color palette, restricted to the 10 intensity steps
 * (100–950) the picker's slider exposes. Values are copied verbatim from
 * `tailwindcss/colors` so they always match whatever ships in the CSS build.
 */
...
export type TailwindColorFamily = Record<TailwindShade, string>;

export type TailwindPalette = Record<string, TailwindColorFamily>;

export const defaultTailwindPalette: TailwindPalette = {
  slate: {
